...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "pdkirange236@gmail.com",
    href: "mailto:pdkirange236@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/pushkar-kirange-8b8a15298/",
    content: "/pushkar-kirange",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Pushkar236",
    content: "/Pushkar236",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Pushkar Kirange</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Pushkar Kirange, a Computer Engineering
              undergraduate (expected 2027) from PCET&apos;s PCCoE, Pune.
              I&apos;m passionate about building scalable backend systems,
              RESTful APIs, and full-stack applications using modern
              technologies like Node.js, React.js, and MongoDB.
            </p>
            <p className="mb-10">
              With strong foundations in Data Structures & Algorithms and
              Object-Oriented Programming, I enjoy solving complex problems on
              LeetCode and continuously improving my problem-solving skills.
              I&apos;ve had hands-on experience as a Full-Stack Developer Intern
              at CyberJall Infotech and Libity Infotech, where I worked on
              real-world projects involving AI chatbots, Prisma ORM, and modern
              web technologies.
            </p>
            <p className="mb-10">
              Currently serving as Head Web Developer at OWASP PCCoE and have
              led web development for Anantya Techfest (2025 & 2026). I&apos;m
