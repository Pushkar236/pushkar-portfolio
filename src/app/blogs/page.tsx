...
export const metadata = {
  title: "Blog | Pushkar Kirange",
  description:
    "Insights, experiences, and learnings from my journey in full-stack development.",
};
    ...
    <div className="container mx-auto px-4 py-24 min-h-screen font-sans">
      <RevealAnimation>
        ...
        <p className="text-zinc-400 text-center mb-12 max-w-2xl mx-auto">
          Sharing my experiences, projects, and learnings in software
          development.
        </p>
      </RevealAnimation>
