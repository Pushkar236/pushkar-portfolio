...
export const EXPERIENCE: Experience[] = [
  {
    ...
    startDate: "Aug 2025",
    endDate: "Dec 2025",
    title: "Software / Full-Stack Developer Intern",
    company: "CyberJall Infotech",
    description: [
      "Developed backend features using Node.js and MongoDB with clean API design.",
      "Integrated Prisma ORM for better query structure and data consistency.",
      "Built an AI-powered chatbot using Gemini API, later migrated to OpenAI APIs.",
      "Collaborated with cross-functional teams to debug issues and enhance reliability.",
    ],
    skills: [
      SkillNames.NEXTJS,
      SkillNames.NODEJS,
  ...
  },
  {
    ...
    company: "Libity Infotech Pvt. Ltd.",
    description: [
