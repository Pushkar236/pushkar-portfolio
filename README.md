# 🚀 Pushkar Kirange's Portfolio

Welcome to the repository for my personal portfolio website! This is where I showcase my skills, projects, and experience as a Full-Stack Developer. Built with modern web technologies and featuring interactive 3D animations and smooth interactions.

![Portfolio Preview](https://github.com/Pushkar236/3d-portfolio/blob/main/public/assets/projects-screenshots/portfolio/landing.png?raw=true)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/Pushkar236/3d-portfolio.git
   ```
